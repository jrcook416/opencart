...
class ExportImport extends \Opencart\System\Engine\Controller {
	...
	protected function getForm() {
		...
		$data['import'] = $this->url->link('extension/export_import/tool/export_import|upload', 'user_token=' . $this->session->data['user_token']);
		$data['export'] = $this->url->link('extension/export_import/tool/export_import|download', 'user_token=' . $this->session->data['user_token']);
		$data['settings'] = $this->url->link('extension/export_import/tool/export_import|settings', 'user_token=' . $this->session->data['user_token']);
